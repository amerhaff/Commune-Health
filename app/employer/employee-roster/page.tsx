...
import { Plus, UserMinus, Check, Users, ChevronRight, ChevronDown, AlertTriangle, ArrowLeft, Building2 } from 'lucide-react'
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="mt-2 space-y-1">
                <p className="text-sm text-muted-foreground">Enrolled Employees: <span className="font-semibold">{enrollmentFigures.enrolledEmployees}</span></p>
                <p className="text-sm text-muted-foreground">Unenrolled Employees: <span className="font-semibold">{enrollmentFigures.unenrolledEmployees}</span></p>
              </div>
            </div>
            <div>
              ...
              <div className="mt-2 space-y-1">
                <p className="text-sm text-muted-foreground">Enrolled Employees: <span className="font-semibold">{enrollmentFigures.enrolledEmployees}</span></p>
                <p className="text-sm text-muted-foreground">Enrolled Dependents: <span className="font-semibold">{enrollmentFigures.enrolledDependents}</span></p>
              </div>
            </div>
          </div>
        </CardContent>
